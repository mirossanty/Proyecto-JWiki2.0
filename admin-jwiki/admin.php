  ...
  <section class="home-section">
    ...
    <div class="container">
      <ol>
        ...
        <li class="text-justify">Para colocar el link en la sección de vídeos, te recomendamos subir tu ejemplo a youtube y seguido de esto, colocar el link que se genera cuando se coloca la opcion de compartir e incrustrar como html<>
        </li>
