...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="titulo">
        <h2>Lista imágenes de código</h2z>
      </span>
    </div>
    <div class="container f-c">
      ...
      <div class="table">
        <table class="table table-bordered border-dark">
          <caption>Lista de img de código</caption>
          <thead>
            <tr>
              <th scope="col">Título</th>
              <th scope="col">Ruta de la imágen</th>
          ...
          <tbody>
            ...
            while ($regcodigo = $resultadocodigo->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                ...
                                <td><a class='btn btn-danger' href='eliminar-codigo.php?idcodigo=" . $regcodigo['idcodigo'] . "' role='button' onclick='return confirmacion()'>🗑️</a></td>
