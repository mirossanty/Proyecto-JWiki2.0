...
<div class="container f-c texto">
  ...
  <input type="text" name="parrafo" class="form-control" placeholder="Párrafo" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
  ...
  <input type="text" name="no_parrafo" class="form-control" class="form-control" placeholder="no_parrafo" aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Referencias bibliográficas (Formato APA)</span>
  </div>
  <input type="text" name="referencias" class="form-control" placeholder="referencias" aria-label="Username" aria-describedby="basic-addon1">
</div>
