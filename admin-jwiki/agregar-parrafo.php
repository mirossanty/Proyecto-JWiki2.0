...
$resultado=$conexion->query($sql);
 ...
 window.location='agregar-parrafo.php';</script>";
         }else{
             echo "<script>
...
<div class="home-content">
      ...
      <span class="titulo"><h2>Agrega un párrafo</h2z></span>
</div>
<div class="container f-c texto">
  ...
  <input type="text" name="parrafo" class="form-control" placeholder="Párrafo" aria-label="Username" aria-describedby="basic-addon1" pattern="[A-Za-zÁÉÍÓÚñáéíóú0-9\s.,!?()_-]{10,5000}" required>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Ingrese el numero de párrafo (su posición en el tema seleccionado), tome en cuenta que 1 es el primero, dos el segundo...</span>
  </div>
  <input type="number" name="no_parrafo" class="form-control" class="form-control" placeholder="no_parrafo" aria-label="Username" aria-describedby="basic-addon1" pattern="\d{1,4}" required>
  <div class="invalid-feedback">
    El valor introducido no es valido, por favor introduce un valor valido
  </div>
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Referencias bibliográficas (Formato APA)</span>
  </div>
  <input type="text" name="referencias" class="form-control" placeholder="referencias" aria-label="Username" aria-describedby="basic-addon1" pattern="[A-Za-zÁÉÍÓÚñáéíóú0-9\s.,!?()_-]{10,500}" required>
  <div class="invalid-feedback">
    El valor introducido no es valido, por favor introduce un valor valido
  </div>
</div>
