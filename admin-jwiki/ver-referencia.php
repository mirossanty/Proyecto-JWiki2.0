...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="titulo">
        <h2>Lista de referencias bibliográficas</h2>
      </span>
    </div>
    <div class="container f-c">
      ...
      <div class="table">
        <table class="table table-bordered border-dark">
          <caption>Lista de referencias bibliográficas</caption>
          <thead>
            <tr>
          ...
          <tbody>
            ...
            while ($regreferencia = $resultadoreferencia->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                ...
                                <td><a class='btn btn-danger' href='eliminar-referencia.php?idreferencia=" . $regreferencia['idreferencia'] . "' role='button' onclick='return confirmacion()'>🗑️</a></td>
