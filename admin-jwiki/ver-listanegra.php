...
$listanegra = "SELECT listanegra.idlistanegra,listanegra.usuario_list,listanegra.contrasena_list,listanegra.idrol_list,listanegra.nombreR_list,listanegra.email_list,listanegra.profesion_list FROM listanegra AS listanegra;";
$resultadolistanegra = $conexion->query($listanegra);
?>
<!DOCTYPE html>
    ...
    <div class="container f-c">
      ...
      <div class="table">
        <table class="table table-bordered border-dark">
          <caption>Lista negra de usuarios</caption>
          <thead>
            <tr>
              <th scope="col">ID</th>
          ...
          <tbody>
            <?php
            while ($reglistanegra = $resultadolistanegra->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                <td>" . $reglistanegra['idlistanegra'] . "</td>
                                <td>" . $regslistanegra['usuario_list'] . "</td>
                                <td>" . $regslistanegra['contrasena_list'] . "</td>
                                <td>" . $regslistanegra['idrol_list'] . "</td>
                                <td>" . $regslistanegra['nombreR_list'] . "</td>
                                <td>" . $regslistanegra['email_list'] . "</td>
                                <td>" . $regslistanegra['profesion_list'] . "</td>
                            </tr>";
            }
            ?>
          </tbody>
