...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="titulo">
        <h2>Lista de usuarios registrados</h2z>
      </span>
    </div>
          ...
          <tbody>
            ...
            while ($regUsuarios = $resultadousuario->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                ...
                                <td><a class='btn btn-danger' href='eliminarAdmin.php?idusuario=" . $regUsuarios['idusuario'] . "' role='button' onclick='return confirmacion()'>🗑️</a></td>
