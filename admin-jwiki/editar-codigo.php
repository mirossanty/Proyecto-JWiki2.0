...
$resultado=$conexion->query($sql);
$ID = $_GET['idcodigo']; //obtener id de url
$codigo= "SELECT idcodigo,titulo,ruta_imagen,explicacion,idtema FROM codigo WHERE idcodigo = '$ID'";
...
<div class="home-content">
      ...
      <span class="titulo"><h2>Editar imagen de código</h2z></span>
</div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Ruta imágen</span>
  </div>
  <input type="text" name="ruta_imagen" class="form-control" class="form-control"value="<?php echo $fila['ruta_imagen']; ?>"aria-label="Username" aria-describedby="basic-addon1">
</div>
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Explicación</span>
  </div>
  <input type="text" name="explicacion" class="form-control" class="form-control"value="<?php echo $fila['explicacion']; ?>"aria-label="Username" aria-describedby="basic-addon1">
</div>
...
if (isset($_POST["editar"])) {
  ...
  $temas= $_POST['temas'];
  $id= $_POST['ID'];
  $sqlmodificar = "UPDATE codigo SET
  titulo= '$titulo',
