...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="titulo">
        <h2>Lista de vídeos registrados</h2z>
      </span>
    </div>
          ...
          <tbody>
            ...
            while ($regvideo = $resultadovideo->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                ...
                                <td><a class='btn btn-danger' href='eliminar-video.php?idvideo=" . $regvideo['idvideo'] . "' role='button' onclick='return confirmacion()'>🗑️</a></td>
