...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="titulo">
        <h2>Lista de párrafos registrados</h2z>
      </span>
    </div>
          ...
          <tbody>
            ...
            while ($regparrafo = $resultadoparrafo->fetch_array(MYSQLI_BOTH)) {
              echo "<tr>
                                ...
                                <td><a class='btn btn-danger' href='eliminar-parrafo.php?idparrafo=" . $regparrafo['idparrafo'] . "' role='button' onclick='return confirmacion()'>🗑️</a></td>
